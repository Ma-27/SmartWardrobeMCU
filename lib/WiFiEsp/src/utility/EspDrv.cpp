...
char    EspDrv::_networkSsid[][WL_SSID_MAX_LENGTH] = {{"1"},
                                                      {"2"},
                                                      {"3"},
                                                      {"4"},
                                                      {"5"}};
...
*/
bool EspDrv::sendCmdGet(const __FlashStringHelper *cmd, const char *startTag, const char *endTag, char *outStr,
                        int outStrLen) {
    int idx;
    bool ret = false;
...
bool EspDrv::sendCmdGet(const __FlashStringHelper *cmd, const __FlashStringHelper *startTag,
